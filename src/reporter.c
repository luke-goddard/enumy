...
//     int tot_high = get_tot_high(ar);
//     int tot_medium = get_tot_medium(ar);
//     int tot_low = get_tot_low(ar);
//     int tot_info = get_tot_info(ar);
...
//     for (int x = 0; x < ar->highest_id; x++)
//     {
//         result = cJSON_CreateArray();
//         first = true;
//         count = 0;
//         for (int i = 0; i < tot_high; i++)
//         {
//             current_result = get_result_high(ar, i);
//             if (current_result->issue_id == x)
//             {
//                 if (first)
//                 {
//                     first = false;
...
//             continue;
//         }
//         for (int i = 0; i < tot_medium; i++)
//         {
//             current_result = get_result_medium(ar, i);
//             if (current_result->issue_id == x)
//             {
//                 if (first)
//                 {
...
//             continue;
//         }
//         for (int i = 0; i < tot_low; i++)
//         {
//             current_result = get_result_low(ar, i);
//             if (current_result->issue_id == x)
//             {
//                 if (first)
//                 {
...
//         {
//             current_result = get_result_info(ar, i);
//             if (current_result->issue_id == x)
//             {
//                 if (first)
//                 {
